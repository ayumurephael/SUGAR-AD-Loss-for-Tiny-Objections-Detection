...
if __name__ == '__main__':
    model = YOLO('/root/code/ultralytics/runs/train/exp3/weights/best.pt')  # select your model.pt path (Note: This should likely be a .pt file path for weights, not .yaml; adjust if needed)
